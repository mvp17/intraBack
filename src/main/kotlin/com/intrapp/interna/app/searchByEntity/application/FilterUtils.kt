...
@Service
class FilterUtils(val searchByAdoption: SearchByAdoption) {
    fun filterWhenNoDates(filter: FilterJSONAdoptionDTO, adoptions: MutableList<Adoption>): List<Adoption> {
        ...
        if (filter.hasAdoptionDistrict())
            adoptions.addAll(searchByAdoption.searchAdoptionByDistrict.findAdoptionsByDistrict(filter.adoptionDistrict!!))
        if (filter.hasAdoptionNeigh())
            adoptions.addAll(searchByAdoption.searchAdoptionByNeigh.findAdoptionsByNeigh(filter.adoptionNeigh!!))
    ...
    fun filterWhenOnlyDates(filter: FilterJSONAdoptionDTO, adoptions: MutableList<Adoption>): List<Adoption> {
        if (filter.hasAdoptionFromDate() and !filter.hasAdoptionToDate())
            adoptions.addAll(searchByAdoption.searchAdoptionByDates.findAdoptionsByAdoptionFromDate(filter.adoptionFromDate!!))
        else if (filter.hasAdoptionToDate() and !filter.hasAdoptionFromDate())
            adoptions.addAll(searchByAdoption.searchAdoptionByDates.findAdoptionsByAdoptionToDate(filter.adoptionToDate!!))
        else
            adoptions.addAll(searchByAdoption.searchAdoptionByDates.findAdoptionsByAdoptionFromDateAndAdoptionToDate(
                filter.adoptionFromDate!!,
                filter.adoptionToDate!!
            ))
        return adoptions.distinct()
